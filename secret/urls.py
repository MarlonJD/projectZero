...
urlpatterns = [
    ...
    path('distribution/delete/<pk>/',
         views.distributionAdminDeleteView,
    ...
    path('contentid/delete/<pk>/', views.contentIDAdminDeleteView,
    ...
    path('statistic/add/', views.statisticAdminAddFunctionView,
         name='statistic-add'),
    path('statistic/delete/<pk>/', views.statisticAdminDeleteView,
    ...
    path('statement/delete/<pk>/', views.statementAdminDeleteView,
    ...
    path('announcement/add/', views.annoAdminCreateView.as_view(),
         name='anno-add'),
    path('announcement/delete/<pk>/', views.annoAdminDeleteView,
         name='anno-delete'),
]
